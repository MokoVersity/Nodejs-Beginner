...
* Week1 進度預計於 7 月 11 日上線。完成這個階段後，你將能開始撰寫 Node.js 程式，並學會 REST API 的實作，以及資料庫的儲存
* Week2 進度預計於 7 月 20 日上線。完成這個階段後，你將學會 Node.js 如何與 Web Frontend 的表單互動，並製作一個簡單的產品展示網頁（Products Gallery）
